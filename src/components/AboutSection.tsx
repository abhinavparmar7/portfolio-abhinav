        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-[slide-in-left_0.8s_ease-out]">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-xl border border-cyan-500/20 backdrop-blur-sm hover:border-cyan-400/40 transition-all duration-500 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/10">
              ...
              <p className="text-gray-300 leading-relaxed mb-4 opacity-0 animate-[fade-in_0.8s_ease-out_0.4s_forwards]">
              ...
              <p className="text-gray-300 leading-relaxed opacity-0 animate-[fade-in_0.8s_ease-out_0.6s_forwards]">
          ...
          <div className="space-y-6 animate-[slide-in-right_0.8s_ease-out]">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl border border-cyan-500/20 backdrop-blur-sm hover:border-cyan-400/40 transition-all duration-500 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/10 opacity-0 animate-[fade-in_0.8s_ease-out_0.5s_forwards]">
