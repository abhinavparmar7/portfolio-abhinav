...
const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-b from-muted/20 to-background relative overflow-hidden transition-colors duration-300">
                ...
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="group">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-foreground font-medium group-hover:text-cyan-400 transition-colors duration-300">{skill.name}</span>
                      <span className="text-muted-foreground text-sm group-hover:text-cyan-300 transition-colors duration-300">{skill.level}%</span>
                    </div>
